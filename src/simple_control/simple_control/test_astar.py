...
class TestAStar(unittest.TestCase):
    ...
    def test_backtrack(self):
        ...
        self.testmap[4][6] = 255
        self.testmap[3][6] = 255
        self.testmap[2][6] = 255
        goal_position = [0, 5]
        self.path = self.astar.plan(self.testmap, self.drone_position, goal_position)
        self.expected_path = [[5, 5], [4, 4], [3, 3], [2, 3], [1, 3], [0, 4], [0, 5]]
        self.assertEqual(self.path, self.expected_path)
    
    def test_long_path(self):
        self.testmap[4][2] = 255
        self.testmap[4][3] = 255
        self.testmap[4][4] = 255
        self.testmap[4][5] = 255
        self.testmap[4][6] = 255
        self.testmap[4][7] = 255
        self.testmap[5][7] = 255
        self.testmap[6][7] = 255
        self.testmap[7][7] = 255
        self.testmap[8][7] = 255
        self.testmap[0][5] = 255
        goal_position = [0, 9]
        self.path = self.astar.plan(self.testmap, self.drone_position, goal_position)
        self.expected_path = [[5, 5], [6, 4], [6, 3], [6, 2], [6, 1], [5, 0], [4, 0], [3, 0], [2, 1], [1, 2], [1, 3], [2, 4], [2, 5], [2, 6], [1, 7], [0, 8], [0, 9]]
        self.assertEqual(self.path, self.expected_path)
